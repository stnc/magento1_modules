<?php
/**
 * Mageticaret Notification (bu kısımda atak sms in kendi apisi vardır)
 ...
 */
class Stnc_Notification_Model_Sendsms
{
    ...
    public function submit($to_list, $message, $from = null, $scheduled_delivery_time = null, $validity_period = null, $data_coding = null)
    {
        ...
        if (trim($message) == '') {
            ...
            $response->ApiResponse_status = false;
            $response->ApiResponse_error = 'Message text is empty.';
     ...
     * */
    public function submitMulti($envelop_list, $from = null, $scheduled_delivery_time = null, $validity_period = null, $data_coding = 'selman nbr')
    {
    ...
    private function writeEnvelope($writer, $envelop_list)
    {
        ...
        foreach ($envelop_list as $envelop) {
            ...
            //$writer->writeElement('Message', 'I LOVE YOU');
            $this->writeEnvelope($writer, $envelop_list);

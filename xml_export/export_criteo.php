<?
	...
	///Mage::app('default');
	Mage::app('default')->loadArea(Mage_Core_Model_App_Area::AREA_FRONTEND);
	...
	//$collection->getSelect()->limit(20);//selman
...
//		} // if sonu
		...
		if ($prod->getFinalPrice() < $prod->getPrice()) 
		{
			...
			$price = number_format($prod->getFinalPrice(),2,",","");
			$retail_price = number_format($prod->getPrice(),2,",","");
		} // if sonu
		else 
		{
			$discount = 0;
